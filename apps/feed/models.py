...
from apps.restaurants.models import Restaurant, Menu, MenuCategory, MenuItem, Ingredient

User = get_user_model()


class UserAllergen(TimeStampedUUIDModel):
    user = models.OneToOneField(User, on_delete=models.DO_NOTHING, related_name="myallergens")
